...
function XFrames:CreateSettingsPanel()
	...
	local frame = createPanel(UIParent, 280, 590, "CENTER", UIParent, "CENTER", 0, 0)
	local ui = self:GetUISettings()
	...
	frame.versionText = createText(frame, "GameFontHighlightSmall", 10, "TOPRIGHT", frame, "TOPRIGHT", -12, -14, "RIGHT")
	frame.versionText:SetTextColor(0.76, 0.80, 0.87)
	...
	frame.attributesText = createText(frame, "GameFontHighlightSmall", 10, "TOPLEFT", frame.blizzMoveText, "BOTTOMLEFT", 0, -46, "LEFT")
	frame.attributesText:SetWidth(256)
	frame.attributesText:SetWordWrap(true)
	...
	frame.attributesButton = createButton(frame, "Attributes: On", 118, "TOPLEFT", frame.attributesText, "BOTTOMLEFT", 0, -10, function()
		XFrames:ToggleAttributesFrameEnabled()
	end, 220)
	frame.cdbButton = createButton(frame, "Open CDB Settings", 118, "TOPLEFT", frame.attributesButton, "BOTTOMLEFT", 0, -10, function()
...
function XFrames:RefreshSettingsPanel()
	...
	self.settingsFrame.versionText:SetText(self:GetAddonVersionLabel())
	...
	self.settingsFrame.attributesText:SetText("Show the always-on player attribute panel.")
	...
	setButtonLabel(self.settingsFrame.attributesButton, self:IsAttributesFrameEnabled() and "Attributes: On" or "Attributes: Off")
